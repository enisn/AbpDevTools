...
- [Commands Overview](commands/build.md)
...
- Check out the [Getting Started](getting-started.md) guide for your first project
- Explore individual [Commands](commands/build.md) for specific functionality
